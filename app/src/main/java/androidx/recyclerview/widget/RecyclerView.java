...
public class RecyclerView extends ViewGroup implements ScrollingView,
    ...
    void scrollStep(int dx, int dy, @Nullable int[] consumed) {
        ...
        printLog("【scrollStep】dy = " + dy);

        if (dy != 0) {
            consumedY = mLayout.scrollVerticallyBy(dy, mRecycler, mState);
        }

        printLog("【scrollStep】consumedY = " + consumedY);
    ...
    class ViewFlinger implements Runnable {
        ...
        public void run() {
            ...
            if (scroller.computeScrollOffset()) {
                ...
                printLog("unconsumedX = " + unconsumedX + "; unconsumedY = " + unconsumedY);
    ...
    public abstract static class SmoothScroller {
         ...
         * {@link #onTargetFound(View, State, SmoothScroller.Action)} or
         * {@link #onSeekTargetStep(int, int, State, SmoothScroller.Action)} until
         ...
         * {@link #onTargetFound(View, State, SmoothScroller.Action)} or
         * {@link #onSeekTargetStep(int, int, State, SmoothScroller.Action)}.
         */
