...
import com.example.nestedtestdemo.utils.TabAnimationUtil
import com.example.nestedtestdemo.config.Constant
import com.example.nestedtestdemo.utils.FlingUtils
...
class NestedOuterRecyclerView : RecyclerView, NestedScrollingParent2 {
    ...
    init {
        Constant.outerRecyclerView = this
        flingUtils.attach(this)
...
//        printLog("onNestedScrollAccepted>>>> mNestedScrollingChildView = $mNestedScrollingChildView")
        if (target is NestedInnerRecyclerView){
            ...
            tabAnimationUtil.attch(tabLayoutParam = Constant.tabLayout)
