...
package com.example.nestedtestdemo.widget;
...
public class OverScroller {
    ...
    public boolean computeScrollOffset() {
        ...
        switch (mMode) {
            case SCROLL_MODE:
                ...
                printLog("【computeScrollOffset】in SCROLL_MODE");
                break;
            ...
            case FLING_MODE:
                ...
                printLog("【computeScrollOffset】in FLING_MODE");
                break;
        }
    ...
    public static class SplineOverScroller {
        ...
        public int getSplineFlingVelocity(double distance){
            double m = mFlingFriction * mPhysicalCoeff;
            double d = DECELERATION_RATE - 1.0;
            double f = INFLEXION;
            return (int) ((Math.exp((Math.log(distance / m) * d) / (d + 1)) * m) / f);
        }
        ...
        boolean update() {
            ...
            printLog("【OverScroller】已经滑动的 distance = " + distance + ", 当前的加速度 mCurrVelocity=" + mCurrVelocity);
